...
export function DataBanner() {
  return (
    <div className="flex gap-3 rounded-[var(--radius-md)] border border-cyan/15 bg-bg-subtle px-3 py-2.5 text-xs leading-relaxed text-fg-muted">
      ...
      <p>
        ...
        N/A. Накрутка, боты, обход блокировок и украденные сессии не поддерживаются.
      </p>
    </div>
  );
}
